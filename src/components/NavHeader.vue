<template>
    <nav class="header">
        ...
        <div class="items">
            <div class="item" @mouseenter="showDropdown('notion')" style="cursor:pointer;">
                Notion
            ...
            <div class="item" @mouseenter="showDropdown('explore')" style="cursor:pointer;">
                Explore
    ...
    <div class="child" v-show="showChild" ref="childRef" @mouseleave="hideDropdown">
        <slot name="Notion" v-if="currentDropdown === 'notion'"></slot>
        <slot name="Explore" v-if="currentDropdown === 'explore'"></slot>
    </div>
</template>
